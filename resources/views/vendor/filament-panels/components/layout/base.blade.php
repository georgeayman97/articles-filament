...
>
    <head>
        ...
        <style>
            ...
            /*aside.fi-sidebar.fixed.inset-y-0.start-0.z-30.grid.h-screen.w-\[--sidebar-width\].content-start.overflow-hidden.bg-white.transition-all.dark\:bg-gray-900.lg\:z-0.lg\:bg-transparent.lg\:shadow-none.lg\:ring-0.dark\:lg\:bg-transparent.lg\:translate-x-0.rtl\:lg\:-translate-x-0.fi-sidebar-open.max-w-none.translate-x-0.shadow-xl.ring-1.ring-gray-950\/5.rtl\:-translate-x-0.dark\:ring-white\/10 {*/
        ...
        @else
            <script>
                ...
                if (
                    ...
                    document.getElementById(".fi-sidebar.fixed.inset-y-0.start-0.z-30.grid.h-screen.w-\[--sidebar-width\].content-start.overflow-hidden.bg-white.transition-all.dark\:bg-gray-900.lg\:z-0.lg\:bg-transparent.lg\:shadow-none.lg\:ring-0.dark\:lg\:bg-transparent.lg\:translate-x-0.rtl\:lg\:-translate-x-0.fi-sidebar-open.max-w-none.translate-x-0.shadow-xl.ring-1.ring-gray-950\/5.rtl\:-translate-x-0.dark\:ring-white\/10")
                        .style.color = "blue";
                }
            </script>
        @endif
